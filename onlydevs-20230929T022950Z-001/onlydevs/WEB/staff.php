    ...
    <section class="bg-gray-100 py-16">
        <div class="container mx-auto">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
                ...
                <div class="bg-white p-6 rounded-lg shadow-lg">
                    <img src="melvin_aguilar.jpg" alt="Melvin Aguilar" class="w-32 h-32 mx-auto mb-4 rounded-full">
                    <h3 class="text-xl font-semibold text-gray-800">Melvin Aguilar</h3>
                </div>

                <!-- Tarjeta de Henri Lima -->
                <div class="bg-white p-6 rounded-lg shadow-lg">
                    <img src="henri_lima.jpg" alt="Henri Lima" class="w-32 h-32 mx-auto mb-4 rounded-full">
